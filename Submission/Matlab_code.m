%Author : Sourindu Chatterjee & Rajesh Thomas
%Institution : FAMU FSU College of Engineering, Florida State University
%Instructor : Dr. Simon Foo
%Course : Machine Intelligence (EEL 5930) Fall 2016
%% Data Acquisition
clear all;
clc;
clf;
...
corellaionFactor = [5,8,4,1]
corrFac = [4,0,0,6,10,0,0,8,0,0]

[coeff,scores,latent,~,exp] = pca(inp(:,1:ncols-1),'VariableWeights',weight);%.*corrFac);

%[coeff,scores,latent] = MyPca(inp(:,1:ncols-1));
